...
import SnowDay from "../Snow.gif";
import ClearDay from "../ClearDay.gif";
import ClearNight from "../ClearNight.gif";
import CloudsDay from "../CloudsDay.gif";
import CloudsNight from "../CloudsNight.gif";
