...
import { convertTemperature, getHumidityValue, getVisibilityValue, getWindDirection } from "./assets/components/Helper";
import { WindIcon, HumidityIcon, VisibilityIcon, SunriseIcon, SunsetIcon } from "./assets/components/Icon";

const App = () => {
  const API_KEY = "cba4c222e5bcfec2061ac461d963eee3";
          ...
          {!weather ? (
            <form onSubmit={handleSearch} className="flex flex-col relative">
              <input
                ...
                placeholder="Enter the city (min 3 letters)"
                className="mb-4 p-3 rounded-lg border border-white bg-transparent text-white placeholder-white focus:outline-none focus:border-blue-300 transition duration-300"
              />
              ...
              <button
                type="submit"
                className="bg-purple-700 text-white font-semibold py-2 px-4 rounded transition-colors"
              >
                Get Weather
              </button>
            </form>
